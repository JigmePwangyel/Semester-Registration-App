...
Future<void> getFormType(BuildContext context, String userId) async {
  final apiUrl =
      'http://192.168.77.122:3000/registration/$userId/form'; // Replace with your API endpoint
...
Future<Student> fetchStudentData(String userId) async {
  final apiUrl =
      'http://192.168.77.122:3000/registration/$userId/PersonalDetail'; // Replace with your API endpoint
...
Future<void> fetchAndSetProgramme(BuildContext context, String userId) async {
  final apiUrl = 'http://192.168.77.122:3000/registration/$userId/programme';
...
Future<void> fetchAndTransformData(BuildContext context, String userId) async {
  final response = await http.get(Uri.parse(
      'http://192.168.77.122:3000/registration/$userId/repeatmodule'));
